...
document.querySelectorAll('.service-card, .research-category, .channel-card, .portfolio-item, .stat-item').forEach(el => {
    el.style.opacity = '0';
...
const addHoverSounds = () => {
    const hoverElements = document.querySelectorAll('.service-card, .portfolio-item, .btn');
...
console.log('YBY Innovations website loaded successfully!');